    ...
    <div class="rangkuman-berita d-flex flex-column justify-content-center align-items-center py-5">
        ...
        <div class="row gap-md-0 gap-3" style="width: 75%">
            ...
            <div class="col-md-6 col-12 d-flex flex-column gap-4">
                ...
                <div class="d-flex flex-row gap-3 align-items-center">
                    <img src="{{ asset('assets/images/berita-2.png') }}" alt="" class="card-berita">
                    <div class="d-flex flex-column">
                        <p class="mb-0"><i>#umum</i></p>
                        <p class="mb-1 judul-berita">
                            JAKARTA – Kementerian Pendayagunaan Aparatur
                            Negara dan Reformasi Birokrasi (PANRB) akan
                        </p>
                        <p class="date">
                            <svg width="12" height="14" viewBox="0 0 12 14" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex flex-row gap-3 align-items-center">
                    <img src="{{ asset('assets/images/berita-3.png') }}" alt="" class="card-berita">
                    <div class="d-flex flex-column">
                        <p class="mb-0"><i>##InovasiPelayananPublik</i></p>
                        <p class="mb-1 judul-berita">
                            BALI – Pemerintah daerah terus dipacu untuk
                            menerapkan reformasi birokrasi yang berdampak
                        </p>
                        <p class="date">
                            <svg width="12" height="14" viewBox="0 0 12 14" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex flex-row gap-3 align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <p class="mb-1 judul-berita">
                            WELLINGTON - Upaya mewujudkan pelayanan publik
                            yang berkualitas dan berdampak tidak hanya
                        </p>
                        <p class="date">
                            <svg width="12" height="14" viewBox="0 0 12 14" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
